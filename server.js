...
// adds data validation to entries
...
app.post('/api/animals',(req, res) => {
  ...
  req.body.id = animals.length.toString(); // toString only used on numbers

  // call validation function before creating animal data
...
// wildcard route to catch requests for routes that don't exist
app.get('*', (req, res) => {
  res.sendFile(path.join(__dirname, './public/index.html'));
})
